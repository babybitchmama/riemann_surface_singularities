...
## Log
Last stopping point: started changing `polar_2d.py` to work for non-radially-symmetric scenarios. It now works -ish but I need to extend to the conformal cone.